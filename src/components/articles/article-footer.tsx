...
export function ArticleFooter() {
    ...
    return (
        <footer className="bg-foreground text-primary-foreground mt-16 py-12">
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 text-sm">
                            {sources.map(source => (
                                <li key={source.name}>
                                    <a href={source.url} target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-primary-foreground hover:underline transition-colors">
                                        {source.name}
                                    </a>
                                </li>
                            ))}
                ...
                <div className="border-t border-primary-foreground/10 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center text-sm">
                    <p className="text-primary-foreground/50">&copy; {new Date().getFullYear()} Valentor RE. All Rights Reserved.</p>
                     <div className="flex justify-center gap-6 text-sm text-primary-foreground/70 mt-4 md:mt-0">
